...
pub struct Translations {
    ...
    pub kb_copy_details: &'static str,
    ...
    pub fn for_lang(lang: Lang) -> Self {
        match lang {
            Lang::En => Self {
                ...
                kb_copy_details: "Copy displayed key details",
            ...
            Lang::De => Self {
                ...
                kb_copy_details: "Angezeigte Schl\u{00FC}sseldetails kopieren",
            ...
            Lang::Fr => Self {
                ...
                kb_copy_details: "Copier les d\u{00E9}tails affich\u{00E9}s de la cl\u{00E9}",
